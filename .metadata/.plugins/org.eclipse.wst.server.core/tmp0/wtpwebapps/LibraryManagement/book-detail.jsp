            ...
            <div class="col-md-8">
                <div class="card-body p-5">
                    <div class="mb-2">
                        ...
                        <span class="text-muted small ml-2">Mã sách: #00${book.id}</span>
                    </div>
                    
                    <h1 class="display-4 font-weight-bold text-gray-900 mb-3">${book.title}</h1>
                    
                    <h5 class="text-primary mb-4">
                        <i class="fas fa-user-nib mr-2"></i>Tác giả: <span class="text-dark">${book.author}</span>
                    </h5>

                    <div class="row mb-4">
                        <div class="col-6 col-md-4">
                            <div class="p-3 border rounded bg-light">
                                <small class="text-uppercase text-muted d-block">Trạng thái</small>
                                <span class="font-weight-bold ${book.quantity > 0 ? 'text-success' : 'text-danger'}">
                        ...
                        <div class="col-6 col-md-4">
                            <div class="p-3 border rounded bg-light">
                                <small class="text-uppercase text-muted d-block">Số lượng kho</small>
                                <span class="font-weight-bold text-dark">${book.quantity} cuốn</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <p class="text-secondary leading-relaxed">
                        ...
                        Nội dung mang đến những kiến thức sâu sắc và giá trị, phù hợp cho mọi độc giả muốn khám phá 
                        và nâng cao vốn hiểu biết của mình trong lĩnh vực này.
                    </p>

                    <hr class="my-4">

                    <div class="d-flex align-items-center">
                        <button class="btn btn-primary btn-lg px-5 shadow mr-3 ${book.quantity == 0 ? 'disabled' : ''}">
                            <i class="fas fa-shopping-cart mr-2"></i>Đăng ký mượn
                        </button>
                        <a href="loadBook?bid=${book.id}" class="btn btn-outline-info btn-lg">
