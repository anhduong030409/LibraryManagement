...
<style>
/* Đảm bảo lịch luôn nằm trên Modal */
.flatpickr-calendar {
						...
						<div class="card-body">
							<form action="${pageContext.request.contextPath}/editReader"
								...
								<div class="form-group">
									<label>Mã Sinh Viên (Không được sửa)</label> <input
										value="${detail.student_id}" name="sid" type="text" readonly
										class="form-control">
								</div>
								<div class="form-group">
									<label>Họ và Tên</label> <input value="${detail.fullname}"
										name="name" type="text" required class="form-control">
								</div>
								<div class="form-group">
									<label>Email</label> <input value="${detail.email}"
										name="email" type="email" required class="form-control">
								</div>
								
								<div class="form-group">
									<label class="font-weight-bold">Số điện thoại</label> <input
										value="${detail.phone}" name="phone" type="text" 
								...
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input id="datePicker" name="date" value="${detail.join_date}"
