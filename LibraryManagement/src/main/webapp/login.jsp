...
<head>
    ...
    <style>
        .bg-login-image {
            background: url('https://images.unsplash.com/photo-1507842217343-583bb7270b66?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80');
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">Hệ thống Quản lý Thư viện Pro</p>
                                    </div>
                                    ...
                                    </form><p class="text-danger">${error}</p>
                                    <hr>
                                    <div class="text-center">
